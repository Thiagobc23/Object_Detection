...
python eval.py --logtostdeer --checkpoint_dir=C:\py\Whale_tail_Detection\train --eval_dir=C:\py\Whale_tail_Detection\test --pipeline_config_path=‪C:\py\Whale_tail_Detection\IG\pipeline.config

IMPORTANT -> object_detection/utils/object_detection_evaluation.py
Change unicode(category_name, 'utf-8') for str(category_name, 'utf-8')
ln 213 and ln 351
